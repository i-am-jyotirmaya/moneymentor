    ...
    IOptions<ResendOptions> options) : ITransactionalEmailSender
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return EmailSendResult.Failure("Resend email delivery requires Resend:ApiKey and Resend:FromAddress.");
        }
        ...
        try
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                try
                {
                    ...
                    return EmailSendResult.Failure("Resend returned no message ID.");
                }
                catch (JsonException)
                {
        ...
        {
            return EmailSendResult.Failure("Resend timed out; delivery may have occurred.");
        }
    }
